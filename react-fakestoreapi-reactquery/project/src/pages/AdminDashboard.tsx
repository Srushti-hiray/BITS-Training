...
const AdminDashboard = () => {
  ...
  const addProductMutation = useMutation<AxiosResponse<Product>, Error, Omit<Product, 'id'>>({
  ...
  const handleUpdateProduct = async () => {
    ...
    try {
      const response: AxiosResponse<Product> = await updateProduct(editingProduct.id, editingProduct);
