...
function fetchProductDetailspro(productId) {
...
function addToCartpro(productId) {
    fetch("https://fakestoreapi.com/products/".concat(productId))
        ...
        alert("".concat(product.title, " added to cart!"));
    })
        .catch(function (error) { return console.error('Error adding to cart:', error); });
}
